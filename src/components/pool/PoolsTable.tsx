...
export function PoolsTable({ children }: { children?: React.ReactNode }) {
  return (
    <>
      <PoolsContainer>
        {/*<div*/}
...
const PoolsTableHeaderText = styled(AutoColumn)`
  font-size: 1rem;
  color: ${({ theme }: { theme: DefaultTheme }) => theme.primary1};
  text-align: center;
`

const PoolsTableHeaderContainer = styled(AutoRow)`
  //background: ${({ theme }: { theme: DefaultTheme }) => theme.secondary1_30};
  //box-shadow: 0px 0px 1px rgba(0, 0, 0, 0.01), 0px 4px 8px rgba(0, 0, 0, 0.04), 0px 16px 24px rgba(0, 0, 0, 0.04),
  //  0px 24px 32px rgba(0, 0, 0, 0.01);
...
export function PoolsTableHeader() {
  return (
    <PoolsTableHeaderContainer justify={'space-between'}>
      <PoolsTableHeaderText>Pool</PoolsTableHeaderText>
      <PoolsTableHeaderText>TVL</PoolsTableHeaderText>
      <PoolsTableHeaderText>Rewards (per Week)</PoolsTableHeaderText>
      <PoolsTableHeaderText>APR</PoolsTableHeaderText>
      <PoolsTableHeaderText>Your Deposit</PoolsTableHeaderText>
