...
const PoolsHeadingContainer = styled.div`
  max-width: 1080px;
  width: 100%;
  margin-top: 1%;
  //margin-bottom: 2%;
...
export const PoolsHeading = () => {
  return (
    <PoolsHeadingContainer>
      <HeaderTextLine>
        <PotionIcon2 width={60} height={60} />
        <HeadingText>Pools</HeadingText>
      </HeaderTextLine>
      <DescriptionText>Earn fees and rewards by depositing and staking tokens.</DescriptionText>
      {/*<HR />*/}
    </PoolsHeadingContainer>
  )
}
